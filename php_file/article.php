...
$result = mysqli_query($conn,"SELECT * FROM article a JOIN articles_metadata b ON a.ARTICLE_ID = b.ARTICLE_ID JOIN topics c ON b.topic_id = c.ID where a.ARTICLE_ID = " .$_GET["id"]);
?>
<!DOCTYPE html>
<html>
                ...
                <div class="page-wrapper">
                    <div class="blog-title-area">
                        <ol class="breadcrumb hidden-xs-down">
                            ...
                            <li class="breadcrumb-item active"><?php echo "<a href='article.php?id=".$row["ARTICLE_ID"]."'>".$row["Title"]."</a>"; ?></li>
                        </ol>

                        <span class="color-aqua"><a href="/" title=""><?php echo $row["value"]; ?></a></span>

                        <h3><?php echo "<a href='article.php?id=".$row["ARTICLE_ID"]."'>".$row["Title"]."</a>"; ?></h3>
                    ...
                    <div class="single-post-media">
                        <img src="images/medical.png" alt="" class="img-fluid">
                    </div><!-- end media -->
